...
function picolight_theme_options_page() {
	...
	<td>
	<input id="custom_favicon" name="picolight_options[custom_favicon]" type="text" value="<?php  esc_attr_e($settings['custom_favicon']); ?>" />
	<br />
	<small class="description"><a href="<?php echo home_url(); ?>/wp-admin/media-new.php" target="_blank"><?php _e('Upload your own favicon image', 'picolight'); ?></a> <?php _e(' using the WordPress Media Library and insert the URL here.', 'picolight'); ?></small>
	</td>
	</tr>
