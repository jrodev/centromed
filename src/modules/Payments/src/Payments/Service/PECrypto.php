...
class PECrypto extends PEService {
     ...
     */
    public function __construct($options = null) // $options is crypto params for config
    {
        if (isset($options)){
    ...
    {   
        $path = $this->_options['securityPath'].'/'.$this->_options['privateKey'];
        flog('pathToKey--->',$path);
